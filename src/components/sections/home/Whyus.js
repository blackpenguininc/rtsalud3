                        ...
                        <div className="col-lg-6 col-md-10">
                            <div className="wcu-text">
                                <div className="section-title left-border mb-40">
                                    <span className="title-tag">¿Qué Hacemos? </span>
                                    <h2 className="title">¿Por qué elegir <br /> RT Salud?</h2>
                                </div>
                                <p>
                                ...
                                <Link to="/contact" className="main-btn main-btn-4">Contáctanos</Link>
                            </div>
                        </div>
                    </div>
